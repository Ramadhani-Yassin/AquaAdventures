...
{
  unlink("../".$prevImage);
header('location:manage-tour-location.php');
}
else
{
...
$query -> execute();
$msg="Tour Location Deleted successfully";
}
?>
<!doctype html>
<html lang="en" class="no-js">
  <head>
    ...
    <title>Aqua Adventure | Manage Tour Locations
    </title>
    <!-- Font awesome -->
    ...
    <div class="ts-main-content">
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <h2 class="page-title">Manage Tour Locations
              </h2>
              <!-- Zero Configuration Table -->
              <div class="panel panel-default">
                <div class="panel-heading">Tour Locations List
                </div>
                      ...
                      <tr>
                        ...
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal"
                          ...
                          <a href="manage-tour-location.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete this tour location?');">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="height: 100%; padding-top: 10%;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Update Tour Location</h5>
                                     ...
                                     <div class="succWrap">
                                       ...
                                       <div class="form-group">
                                         <div class="col-sm-8 col-sm-offset-4">
                                           ...
                                           <button class="btn btn-primary" name="submit" type="submit">Update Location
                                           </button>
                                         </div>
                                       </div>
                                       </form>
