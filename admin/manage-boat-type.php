...
{
  unlink("../".$prevImage);
header('location:manage-boat-type.php');
}
else
{
...
$msg="Boat type deleted successfully";
if($query->execute())
{
   $msg="Boat type deleted successfully";
header('location:manage-boat-type.php');
...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Aqua Adventure | Manage Boat Types</title>
    <!-- Font awesome -->
    ...
    <div class="ts-main-content">
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <h2 class="page-title">Manage Boat Types</h2>
              <!-- Zero Configuration Table -->
              <div class="panel panel-default">
                <div class="panel-heading">Boat Types List</div>
                  ...
                  <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><img width="60px" src="../<?php echo htmlentities($result->sub_category_img);?>" /></td>
                        ...
                        <td>
                         <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal"
                          ...
                          <a href="manage-boat-type.php?del=<?php echo $result->id;?>" onclick="return confirm('Are you sure you want to delete this boat type?');">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="height: 100%; padding-top: 10%;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Update Boat Type</h5>
      ...
      <div class="modal-body">
        <form enctype="multipart/form-data" method="post" class="form-horizontal" onSubmit="return valid();">
          ...
          <?php } else if($msg){?>
            <div class="succWrap"><strong><?php echo htmlentities($msg); ?></strong></div>
          <?php }?>
          <input type="hidden" class="form-control" name="id" id="sub-cat-id" required>
          <div class="form-group">
            <label class="col-sm-4 control-label">Tour Location</label>
            <div class="col-sm-8">
          ...
          <div class="form-group">
            <label class="col-sm-4 control-label">Boat Type</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" name="sub_category_title" id="cat-name" required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-4 control-label">Boat Image</label>
            <div class="col-sm-8">
              <input type="file" class="form-control" name="sub_category_img" id="cat-image">
              <div id="img-name"><img id="catImg" src="" alt="Boat Image" width="100" height="100"></div>
