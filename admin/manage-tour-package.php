...
if($query->execute())
{
    ...
    $msg="Tour package updated successfully";
}
else
{
    $error="Something went wrong. Please try again";
...
$msg="Tour package deleted successfully";
}
...
<head>
    ...
    <title>Aqua Adventure | Manage Tour Packages</title>
    <!-- Font awesome -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Tour Packages List</div>
                                ...
                                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../<?php echo htmlentities($results1[0]->image);?>" style="width:50px;"/></td>
                                            <td><?php echo htmlentities($result->name);?></td>
                                            <td><?php echo htmlentities($result->category);?></td>
                                            <td><?php echo htmlentities($result->sub_category_title);?></td>
                                            <td><?php echo ($result->description);?></td>
                                            <td><?php echo "TZS ".htmlentities($result->price);?></td>
                                            <td><?php echo "TZS ".htmlentities($result->discount);?></td>
                                            <td>
                                                <?php if($result->homepage == 'YES') {?>
                                                <a href="manage-tour-package.php?homepage=<?php echo htmlentities($result->id);?>" onclick="return confirm('Remove from featured packages?')">YES</a>
                                                <?php } else {?>
                                                <a href="manage-tour-package.php?unhomepage=<?php echo htmlentities($result->id);?>" onclick="return confirm('Add to featured packages?')">NO</a>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <a href="javascript: void(0)" data-toggle="modal" data-target="#editModal"
                                                    ...
                                                    <i class="fa fa-pencil" style="color:blue; margin-right:10px;"></i>
                                                </a>
                                                <a href="manage-tour-package.php?del=<?php echo $result->id;?>" onclick="return confirm('Delete this tour package?');">
            ...
            <div class="modal-dialog  modal-lg" role="document" style="height: 100%; padding-top: 10%;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Update Tour Package</h5>
                    ...
                    <div class="modal-body">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="itemprice" class="form-control" id="itemprice" required placeholder="Per person">
                                </div>
                                <label class="col-sm-2 control-label">Discount Price</label>
                                <div class="col-sm-4">
                                    <input type="number" name="discount" class="form-control" id="discount" placeholder="Per person">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" style="word-break: break-all;">Duration<span style="color:red">*</span></label>
                                <div class="col-sm-4">
                                    <input type="text" name="attribute" class="form-control" id="attribute" required placeholder="e.g. 2 hours, full day">
                                </div>
