...
<head>
    ...
    <title>Aqua Adventure | Admin Dashboard</title>
    <!-- Font awesome -->
                ...
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-danger text-light">
                                                <div class="stat-panel text-center">
                                                    ...
                                                    <div class="stat-panel-title text-uppercase">Tour Packages</div>
                                                </div>
                                            </div>
                                            <a href="manage-tour-package.php" class="block-anchor panel-footer text-center">Full Detail &nbsp;<i class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3"><h5><a href="/drugstore/admin/manage-bookings.php" class="pt-3">View All Bookings</a></h5></div>
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php 
                                                $sql = "SELECT orders.*, users.name, users.mobile, users.email,users.address from orders INNER JOIN users on orders.user_id=users.id order by id desc limit 30";
                                                $query = $dbh -> prepare($sql);
                                                $query->execute();
                                                $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                $cnt=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="view-order.php?orderid=<?php echo $result->id;?>" >View Details</a></td>
                                                    <td>
