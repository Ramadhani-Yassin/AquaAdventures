...
if($lastInsertId)
{
   ...
   $msg="Tour package added successfully";
}
else 
{
$error="Something went wrong. Please try again";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Add Tour Package</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">Tour Location<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Boat Type<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-sm-4">
<input type="number" name="itemprice" class="form-control" required placeholder="Per person">
</div>
<label class="col-sm-2 control-label">Discount Price</label>
<div class="col-sm-4">
   <input type="number" name="discount" class="form-control" placeholder="Per person">
</div>
</div>
...
<div class="col-sm-4">
   <input type="text" name="attribute" class="form-control" required placeholder="e.g. 2 hours, full day">
</div>
...
<div class="form-group">
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <button class="btn btn-primary" name="submit" type="submit">Save Package</button>
    </div>
</div>
</form>
</div>
